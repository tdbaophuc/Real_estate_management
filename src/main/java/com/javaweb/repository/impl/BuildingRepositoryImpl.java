...
//        }
    ...
    public List<BuildingEntity> findAll(BuildingSearchBuilder buildingSearchBuilder) {
        ...
        BuildingRepositoryImpl.JoinTable(buildingSearchBuilder,SQL);
        StringBuilder where = new StringBuilder(" Where 1=1 ");
        BuildingRepositoryImpl.queryNomad(buildingSearchBuilder,where);
        BuildingRepositoryImpl.querySpecial(buildingSearchBuilder,where);
        SQL.append(where);
